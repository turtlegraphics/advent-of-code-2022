...
def build(stuff, robots):
    ...
    - Always build obsidian robot if possible (incorrect)
    ...
    # always build obsidian if you can.
    # much faster, but wrong on some blueprints
    if result:
        return result
...
print("""
===========
This code makes an assumption that you should always build
an obsidian robot when you can.  That is incorrect for
blueprints 7 and 10 in my input.
===========
""")
